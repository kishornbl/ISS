<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AuthoBranchList.aspx.cs" Inherits="AuthoBranchList" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <cc1:CalendarExtender ID="CalendarExtender1" PopupButtonID="ImageButton1" runat="server" TargetControlID="toDateTextBox"
     ...
     <td ></td>
     <td colspan="2">
         <asp:DropDownList ID="drpItem" runat="server" Width="200px" Visible="False" >           
         </asp:DropDownList>
        </td>
    ...
    <tr><td>
        ...
        <td colspan="2">
        <asp:Button ID="btnReport" CssClass="menu" runat="server" Text="Show Report" 
