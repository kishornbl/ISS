<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ItemWiseReport.aspx.cs" Inherits="ItemWiseReport" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <cc1:CalendarExtender ID="CalendarExtender1" PopupButtonID="ImageButton1" runat="server" TargetControlID="toDateTextBox"
     ...
     <td >Select Item</td>
     <td colspan="2">
         <asp:DropDownList ID="drpItem" runat="server" Width="200px" >           
         </asp:DropDownList>
        </td>
